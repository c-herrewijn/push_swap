...
SRC_DIR = sources
SRCS = breadth_first_search.c debug_utils.c main.c operations.c parsing.c stack_utils.c
OBJ_DIR = obj
...
BASE_SRCS = breadth_first_search.c debug_utils.c operations.c parsing.c stack_utils.c

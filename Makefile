...
FLAGS = -Wall -Wextra -g
SRC_DIR = sources
SRCS = bfs_add_utils.c bfs_cleanup.c bfs_length_utils.c bfs_prune.c breadth_first_search.c debug_utils.c main.c operations_base.c operations_execute.c parsing.c push_back_to_a.c push_to_b.c stack_utils.c
OBJ_DIR = obj
